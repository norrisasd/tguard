    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
          ...
          <a href="../index.php" class="nav-link">Home</a>
            ...
            <h4 style="margin-top:.5%;"><b>Tasks / Task Search</b></h4>
            <!-- Right navbar links -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <label for="actName">Client Name</label>
                                <select id="actName" class="form-control" onchange="" style="margin-right:0.5%;width:150px">
